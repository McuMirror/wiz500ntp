/*
NOTE: 
- Sua loi fraction of Second, sai toc do HCLK do ngo ngan @@ RCC_CFGR_PLLMULL9
- 8Sep2022: loi NTP gui thoi gian bi sai!!!
...
#include "socket.h"
const time_t built_time = 1663748760;
time_t timenow;
...
{//=> Ban tin GPS: $GPS034007060819AA10	
	...
	{
		//Tai thoi diem nhan dc ban tin thi phan le cua giay it nhat da tre 50ms!!!
		TIM3->CNT = 600;//60ms
